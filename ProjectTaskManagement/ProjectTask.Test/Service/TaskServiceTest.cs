...
namespace ProjectTask.Test.Service
{
    ...
    public class TaskServiceTest
    {
        ...
        {
            _taskRepository.Setup(t => t.CreateTask(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<long>(), It.IsAny<long>()))
                .ThrowsAsync(new ArgumentException());

            var taskService = new TaskService(_taskRepository.Object, _projectService.Object);

            Assert.ThrowsAsync<ArgumentException>(() => taskService.CreateTask("", "Description", 1, 1));
        }
        ...
        public void CreateTask_NameNull()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(() => taskService.CreateTask(null, "Description", 1, 1));
        }
        ...
        public void CreateTask_DescriptionEmpty()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(() => taskService.CreateTask("Task1", "", 1, 1));
        }
        ...
        public void CreateTask_DescriptionNull()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(() => taskService.CreateTask("Task1", null, 1, 1));
        }
        ...
        public void CreateTask_ProjectIdError()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(() => taskService.CreateTask("Task1", "Description", 0, 1));
        }
        ...
        public void CreateTask_TaskeeIdError()
        {
            ...
            Assert.ThrowsAsync<ArgumentException>(() => taskService.CreateTask("Task1", "Description", 1, 0));
        }
        ...
        public async Task CreateTask_Success()
        {
            ...
            await taskService.CreateTask("Task1", "Description", 1, 1);

            _taskRepository.Verify(t => t.CreateTask(It.IsAny<string>(), It.IsAny<string>(), It.IsAny<long>(), It.IsAny<long>()), Times.Once);
        }
